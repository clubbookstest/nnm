/**
 * $Id: editor_plugin_src.js 1.00 2009-08-24
 *
 * @author Marketto.ru -- Viktor Kuzhelny
 * @copyright Copyright © 2009, Marketto.ru, All rights reserved.
 */
...
(function() {
	...
	tinymce.create('tinymce.plugins.MarkettoImagesPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('markettoImages', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 320 + parseInt(ed.getLang('markettoimages.delta_width', 0)),
					height : 170 + parseInt(ed.getLang('markettoimages.delta_height', 0)),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				longname : 'Marketto.ru Images Plugin',
				author : 'Viktor Kuzhelny',
				authorurl : 'http://marketto.ru/',
				infourl : 'http://marketto.ru/page/tinymce-images-plugin',
				version : "1.0"
			};
		}
	});
