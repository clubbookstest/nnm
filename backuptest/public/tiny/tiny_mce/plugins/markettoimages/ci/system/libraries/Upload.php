...
class CI_Upload {
	...
	var $latinize_name	= TRUE; //`latinize` update by me
	...
	function initialize($config = array())
	{
		$defaults = array(
							...
							'latinize_name'		=> TRUE		//`latinize` update by me
						);	
	...
	function set_filename($path, $filename)
	{
		...
		elseif ($this->latinize_name == TRUE) //`latinize` update: condition was fully added by me
		{
			$ci =& get_instance();
			$ci->load->helper('url'); //uses `url` subhelper in application/helpers
			
			$filename = url_title_rus($filename); //a function in `url` subhelper (see above)
		}
