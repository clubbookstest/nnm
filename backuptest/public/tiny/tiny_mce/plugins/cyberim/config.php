...
$conf['filesystem.path'] = 'http://www.bookclub.ua/images/db/news/';
//относительный путь к файлам пользователя
$conf['filesystem.files_path'] = $_SERVER['DOCUMENT_ROOT'].'/images/db/news';
//регулярное выражения описания пропускаемых каталогов
//$conf['filesystem.exclude_directory_pattern'] = '*';
...
$conf['filesystem.file_chmod'] = 0644;
...
$conf['thumbnail.driver'] = 'ImageMagick';
